...
def generate_launch_description():
    ...
    robot_description_content = Command(
        [
            ...
            PathJoinSubstitution([FindPackageShare('ur3_pick_place'), 'urdf', 'ur3_fixed.urdf.xacro'])
        ]
    )
    ...
    bridge = Node(
        ...
        arguments=[
            ...
            '/model/ur3/visual@gz.msgs.Visual[gz.msgs.Visual'
        ],
        output='screen'
    )
    ...
    return LaunchDescription([
        ...
        RegisterEventHandler(
            event_handler=OnProcessExit(
                ...
                on_exit=[bridge, relay_node, rviz_node]
            )
        )
    ])
